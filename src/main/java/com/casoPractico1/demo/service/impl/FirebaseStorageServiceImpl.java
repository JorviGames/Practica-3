package com.casoPractico1.demo.service.impl;
...
@Override
    ...
    private String uploadFile(File file, String carpeta, String fileName) throws IOException {
        ...
        String url = storage.signUrl(blobInfo, 90, TimeUnit.DAYS, SignUrlOption.signWith((ServiceAccountSigner) credentials)).toString();
        return url;
    }
